...
#Build sql 
	sql = "select id,title,subject,date,p_from,p_to,body from docs \
			...
			and id in \
			('frus1969-76ve12d70','frus1969-76v38p1d58','frus1969-76ve08d261','frus1969-76ve08d200','frus1969-76v39d288', \
			'frus1969-76ve06d230','frus1969-76ve14p1d178','frus1969-76ve12d72','frus1969-76v39d292','frus1969-76v37d64', \
			'frus1969-76ve06d231','frus1969-76ve14p1d179');"%(int(date_year),int(date_month))
